...
public class ServerBridge {
	...
	public static final String DEFAULT_BASE_URL = "http://things.ubidots.com/api/v1.6/";
	...
	ServerBridge(String apiKey) throws IOException {
		this(apiKey, DEFAULT_BASE_URL);
	}

	ServerBridge(String apiKey, String baseUrl) throws IOException {
	...
	private void recieveToken() throws IOException {
		Gson gson = new Gson();
	...
	private String postWithApiKey(String path) throws IOException {
